                    ...
                    <div class="product-thumb-hover" style="height: 240px;">
                        <a href="{{ route('product.detail',['id' => $Product->Product->id]) }}" class="woocommerce-LoopProduct-link">
                            @if($Product->Product->Images && $Product->Product->Images->isNotEmpty())
                                ...
                                @endif
                            @else
                                <img width="470" height="594" src="/pd/images/product/images/NO-IMAGE-AVAILABLE.jpg" class="attachment-shop_catalog size-shop_catalog wp-post-image" alt="">
                                <img width="470" height="594" src="/pd/images/product/images/NO-IMAGE-AVAILABLE.jpg" class="hover-image back" alt="">
                            @endif
                        </a>
                    </div>
                </div>
