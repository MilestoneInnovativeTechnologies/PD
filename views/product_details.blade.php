...
$relat = ['Brand' => ['Group02','name'], 'Category' => ['Group01','name'], 'Size' => ['Group03','name']];
$details = ['Brand' => ['Group02','name'], "Product" => "name", "Category" => ['Group01','name'], "Code" => "code", "Reference" => "narration4", "Re-Order" => "narration3", "Rack" => "narration5", "Price" => "narration6"];
@endphp
@section('content')
                                            ...
                                            <div class="row">
                                                <div class="col-sm-2">
                                                    <div id="image-thumbnail" class="image-thumbnail slick-carousel" data-columns4="5" data-columns3="5" data-columns2="5" data-columns1="5" data-columns="5" data-nav="true" data-vertical=&quot;true&quot; data-verticalswiping=&quot;true&quot;>
                                                        ...
                                                        @empty
                                                            <div class="img-thumbnail">
                                                                <a href="/pd/images/product/images/NO-IMAGE-AVAILABLE.jpg" data-image="/pd/images/product/images/NO-IMAGE-AVAILABLE.jpg" class="img-thumbnail first active" title="">
                                                                    <img width="470" height="594" src="/pd/images/product/images/NO-IMAGE-AVAILABLE.jpg" class="attachment-shop_catalog size-shop_catalog" alt="{{ $Product->name }}" title="{{ $Product->name }}" data-zoom-image="/pd/images/product/images/NO-IMAGE-AVAILABLE.jpg"/>
                                                                </a>
                                                            </div>
                                                        @endforelse
                                                    </div>
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="image-additional text-center">
                                                        @if($Product->Images->isNotEmpty())
                                                            ...
                                                            @else
                                                            <div data-thumb="/pd/images/product/images/NO-IMAGE-AVAILABLE.jpg" class="woocommerce-product-gallery__image">
                                                                <a href="/pd/images/product/images/NO-IMAGE-AVAILABLE.jpg">
                                                                    <img width="720" height="909" src="/pd/images/product/images/NO-IMAGE-AVAILABLE.jpg" class="attachment-shop_single size-shop_single wp-post-image" alt="" id="image" title="" data-src="/pd/images/product/images/NO-IMAGE-AVAILABLE.jpg" data-large_image="/pd/images/product/images/NO-IMAGE-AVAILABLE.jpg" data-large_image_width="950" data-large_image_height="1200"/>
                                                                </a>
                                                            </div>
                                                        @endif
                                                    </div>
