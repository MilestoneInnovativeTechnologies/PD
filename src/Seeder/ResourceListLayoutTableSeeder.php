...
class ResourceListLayoutTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Milestone\Appframe\Model\ResourceListLayout::query()
            ...
            ->create([	'id' => '517', 	'resource_list' => '505', 	'label' => 'Name', 	'field' => 'name', 	'relation' => '508', 											])
            ...
            ->create([	'id' => '520', 	'resource_list' => '505', 	'label' => 'Code', 	'field' => 'code', 												])
            ->create([	'id' => '521', 	'resource_list' => '505', 	'label' => 'Gender', 	'field' => 'narration2', 												])
