...
class ResourceListLayoutTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Milestone\Appframe\Model\ResourceListLayout::query()
            ...
            ->create([	'id' => '50017', 	'resource_list' => '50005', 	'label' => 'Name', 	'field' => 'name', 	'relation' => '50016', 											])
            ->create([	'id' => '50018', 	'resource_list' => '50005', 	'label' => 'Group 01', 	'field' => 'name', 	'relation' => '50013', 											])
            ->create([	'id' => '50019', 	'resource_list' => '50005', 	'label' => 'Group 02', 	'field' => 'name', 	'relation' => '50014', 											])
            ...
            ->create([	'id' => '50026', 	'resource_list' => '50007', 	'label' => 'Author', 	'field' => 'name', 	'relation' => '50027', 											])
            ...
            ->create([	'id' => '50029', 	'resource_list' => '50008', 	'label' => 'Author', 	'field' => 'name', 	'relation' => '50027', 											])
            ...
            ->create([	'id' => '50033', 	'resource_list' => '50009', 	'label' => 'Author', 	'field' => 'name', 	'relation' => '50035', 											])
            ->create([	'id' => '50034', 	'resource_list' => '50010', 	'label' => 'Name', 	'field' => 'name', 												])
            ->create([	'id' => '50035', 	'resource_list' => '50010', 	'label' => 'Status', 	'field' => 'status', 												])
            ->create([	'id' => '50036', 	'resource_list' => '50011', 	'label' => 'Product', 	'field' => 'name', 	'relation' => '50040', 											])
            ->create([	'id' => '50037', 	'resource_list' => '50011', 	'label' => 'Added By', 	'field' => 'name', 	'relation' => '50037', 											])
            ->create([	'id' => '50038', 	'resource_list' => '50011', 	'label' => 'Removed By', 	'field' => 'name', 	'relation' => '50038', 											])
        ;
