...
class ResourceActionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \Milestone\Appframe\Model\ResourceAction::query()
            ->create([	'id' => '50001', 	'resource' => '50002', 	'name' => 'Group01ListAction', 	'description' => 'Action to call list of items in group 01', 			'menu' => 'Group 01 Items', 									])
            ->create([	'id' => '50002', 	'resource' => '50002', 	'name' => 'Group02ListAction', 	'description' => 'Action to call list of items in group 02', 			'menu' => 'Group 02 Items', 									])
            ->create([	'id' => '50003', 	'resource' => '50002', 	'name' => 'Group03ListAction', 	'description' => 'Action to call list of items in group 03', 			'menu' => 'Group 03 Items', 									])
            ->create([	'id' => '50004', 	'resource' => '50002', 	'name' => 'Group04ListAction', 	'description' => 'Action to call list of items in group 04', 			'menu' => 'Group 04 Items', 									])
            ...
            ->create([	'id' => '50011', 	'resource' => '50002', 	'name' => 'Group01ProductsListAction', 	'description' => 'Action to list all products of group 01', 	'title' => 'Products', 											])
            ->create([	'id' => '50012', 	'resource' => '50002', 	'name' => 'Group02ProductsListAction', 	'description' => 'Action to list all products of group 02', 	'title' => 'Products', 											])
            ->create([	'id' => '50013', 	'resource' => '50002', 	'name' => 'Group03ProductsListAction', 	'description' => 'Action to list all products of group 03', 	'title' => 'Products', 											])
            ->create([	'id' => '50014', 	'resource' => '50002', 	'name' => 'Group04ProductsListAction', 	'description' => 'Action to list all products of group 04', 	'title' => 'Products', 											])
