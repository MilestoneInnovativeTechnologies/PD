...
{
    public static $SearchFields = ['description'], $detailFields = ['id','name','description'];
    public static $relationsGroup = ['Group01','Group02','Group03','Group04','Group05','Group06','Group07','Group08','Group09','Group10'];
