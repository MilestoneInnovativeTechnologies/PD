...
use Milestone\PD\Mail\ShareWishlist;

class WishListController extends Controller
{
    public function page(){
        $vid = Cookie::get('__pd_visitor');
        $visitor = ($vid) ? Visitor::find($vid) : null;
        return view('pd::wishlist')->with(compact('visitor'));
    }
    ...
    public function in($code){
        ...
        return redirect()->route('wishlist.detail',$wishlist)->cookie('__pd_visitor',$visitor->id,30*24*60,'/');
    }
}
